...
Where `<STAGE>` is the tutorial stage whose firmware is to be run. For example, to run Stage 5's firmware, the following command is used:

```
xrun --xscope bin/stage5.xe
```
